...
/// v13-v17.
///
/// Bumped 18 → 19 for [`Event::TccDecision`] and [`Event::GatekeeperVerdict`]
...
/// variants; same serialization-visible reasoning as v13-v18.
///
/// Bumped 19 → 20 for [`Event::FileQuarantine`], [`Event::Mount`],
...
/// `FileQuarantine`/`XpcConnect` are macOS-only families per the v19
/// precedent. Same serialization-visible reasoning as v13-v19.
