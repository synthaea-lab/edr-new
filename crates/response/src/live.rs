...
//! dead-box analysis) — the analyst-driven half of this crate, next to the
//! automated verdict-driven half in the crate root: an interactive, auditable
//! session on a live endpoint, established through
